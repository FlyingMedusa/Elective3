...
for i in esop.split():
    if i in consmap:
        ...
        voiced += 1
        vowels += 1
print('The text \'esop\' contains', voiced, 'voiced phonemes and', voiceless, 
      'voiceless ones, the voiced phonemes therefore constitute', str(round((voiced/(voiced+voiceless))*100,2))+
      '%. In the text, there are', vowels, 'vowels and', consonants, 'consonants.')